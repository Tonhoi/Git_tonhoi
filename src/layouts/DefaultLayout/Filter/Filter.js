...
import { setDisplay, setSaveSort } from "../../../redux/reducer";
...
const Filter = () => {
  ...
  const handSortField = (e) => {
    ...
    // setSaveSort((prev) => {
    //   console.log(prev);
    //   console.log(Object.keys(prev).length);
    //   return {
    //     ...saveSort,
    ...
    // });
    setSaveSort((prev) => {
      const text = Object.keys(prev).map((prev) => {
        console.log(prev);
      });
      // console.log(prev);
      return {
  ...
  return (
    <div className={cx("wrapper")}>
      <div className={cx("wrapper-content")}>
        <div>
          <span>Sắp xếp</span>
          <select name="sort" id="sort" onChange={handSortField}>
        ...
        <div>
          <span>Danh mục</span>
          <select name="danhmuc" id="cars" onChange={handSortField}>
        ...
        <div>
          <span>Thể loại</span>
          <select name="category" id="cars" onChange={handSortField}>
        ...
        <div>
          <span>Quốc gia</span>
          <select name="country" id="cars" onChange={handSortField}>
        ...
        <div>
          ...
          <select name="year" id="cars" onChange={handSortField}>
