...
export const ChatIcon = ({ className, width = "2rem", height = "2rem" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width={width}
...
export const BellIcon = ({ className, width = "2rem", height = "2rem" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width={width}
...
export const MovieIcon = ({ className, width = "2rem", height = "2rem" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width={width}
